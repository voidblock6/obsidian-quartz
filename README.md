...
This repository contains part of the fantasy world I am writing, which is published on my website: https://worldbuilding.voidblock.dev.
...
All files under the `content/` directory are licensed under the **[CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/deed.en)** license. See `LICENSE-CONTENT.txt` for details.
